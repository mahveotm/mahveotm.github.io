...
Weeks ago, I was granted early access to [MTN Cloud](https://cloud.mtn.ng/){:target="_blank"}, and I've had a fun time tinkering around it. 
...
MTN Cloud runs a [customized OpenStack environment](https://www.openstack.org){:target="_blank"} managed through the [Morpheus Cloud Management Console](https://morpheusdata.com){:target="_blank"}. It offers a variety of operating system images, including CentOS, Debian 12/13, Ubuntu 22/24, and Windows Server 2019/2022.
...
[WebAuthn Starter Kit – Yubico Developer Guide](https://developers.yubico.com/Developer_Program/WebAuthn_Starter_Kit/Front-End_System_Design.html){:target="_blank"}
...
Technical write-ups like [*Building and Operating a Pretty Big Storage System*](https://www.allthingsdistributed.com/2023/07/building-and-operating-a-pretty-big-storage-system.html){:target="_blank"} and [*How Azure.com Operates on Azure*](https://azure.microsoft.com/en-us/blog/how-azurecom-operates-on-azure-part-2-technology-and-architecture/){:target="_blank"} build credibility and trust. Publishing similar deep dives would promote transparency and long-term engagement.
...
### Pricing
The price of the **GLD2x** is the cover image for this article. The currency icon should atleast be Naira. [Here's what they were probably thinking.](https://youtu.be/IpwSXWq1wwU){:target="_blank"}

Above all, great work by the MTN Cloud team. I’ve enjoyed using it so far.

[Close out](https://youtu.be/IpwSXWq1wwU){:target="_blank"}
